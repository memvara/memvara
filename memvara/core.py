...
_DEGRADED_HEADER = (
    ...
    "live in X\", \"I work at X\", \"I'm allergic to X\", \"email me from now on\", "
    "\"everything comes to <address>\", a phone number on a line of its own, ...). "
    "Anything else — an employer mentioned in passing, a version number, an error code, "
    "a preference stated as an aside — reaches the extraction tier, finds no model "
    "there, and is dropped. WriteReceipt.unextracted counts those turns, and repr(mem) "
    "names the extractor in use.\n\n"
