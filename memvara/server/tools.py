...
TOOLS: tuple[Tool, ...] = (
    ...
    Tool(
        ...
        description=(
            ...
            "'user', predicate 'lives_in', object 'Lisbon'. If the fact did not start "
            "being true at this moment — you are recording something from earlier in "
            "the session, from a log, or from what the user just told you about last "
            "month — say so with true_since, because the default records it as "
            "beginning now and a fact that had already changed by then is stored as a "
