...
#: `extraction_chunks`, `ingest_urls`, `ingest_media` or `encryption`; they are listed so
#: the two tuples stay equal, and the library, not this file, decides that
...
FEATURES = ("index_command", "research_agent", "project_scope", "status_line",
            ...
            "ingest_media", "query_rewrite", "synthesis", "encryption")
