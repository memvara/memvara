...
```bash
python3 scripts/memvara_auth.py authenticate
```

`scripts/` is next to this `SKILL.md`, in this skill's own directory. Standard
library only, and nothing is left running when it returns.
