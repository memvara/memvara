...
| The adversarial test suite: tiers, the harness, the skip ledger, known bugs, the reference model, crash tests | `docs/claude/testing.md` | `tests/harness/`, `tests/adversarial/` |
