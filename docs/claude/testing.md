...
Run the fast tier with `pytest tests/adversarial/hooks`, which took 15 seconds on a laptop, and the nightly tier with `pytest tests/adversarial/hooks/nightly --tier nightly`, which took about 20.
