...
**Status as of `0.8.0`.** 3,591 tests, 100% statement coverage, mypy clean, CI on
...
1. **End-to-end answer quality has an apparatus and one non-reproducible run, and no
   ...
   answers.
2. **No external user has run this in production.** 3,591 tests prove the code does what we
