...
| [Agent Memory Benchmark](benchmarks/agent-memory-benchmark.md) | A system-neutral benchmark for memory over changing facts, with results for memvara in two configurations and two baselines |
